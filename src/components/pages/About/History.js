        ...
        <Accordion sx={{ mt: '2.5%' }} >
            ...
            <AccordionDetails sx= {{bgcolor: 'secondary.main'}}>
                <Typography variant='body1' sx={{color: 'background.default'}}>
                    &emsp; &emsp;From a young age, I've loved solving puzzles and making my ideas come to life. I can vividly remember <Link target = "_blank" href="http://www.legoengineering.com/platform/robolab/" aria-label='link to Robolab page for further information'>ROBOLAB</Link> being my favorite part of school in my elementary years - engineering inventions out of legos and programming them to come to life. I have dedicated my career journey, no matter the field I'm in, to solving real world problems and designing creative solutions.
                    <br />
                    <br />
